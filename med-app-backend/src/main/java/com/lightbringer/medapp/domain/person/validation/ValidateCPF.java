...
public class ValidateCPF implements ValidateDocument {
    ...
    private String ERRO_AO_SALVAR = "ERRO AO SALVAR! O CPF: %s JÁ EXISTE NO PACIENTE DE CÓDIGO: %s.";

    private final PatientRepository patientRepository;

    @Override
    public void validateDocument(String document) {
        Patient patientWithDocument = patientRepository.findByCPF(document);
